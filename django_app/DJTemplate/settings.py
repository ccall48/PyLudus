...
# Fusion auth Keys - Note store this outside the settings page later and pull it in from another file
...
DATABASES = {
    'default': {
        ...
        # Note that I have changed this because of an error on the built in line - Probably only a windows issue here.
